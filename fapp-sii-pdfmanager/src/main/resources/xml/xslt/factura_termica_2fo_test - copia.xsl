...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="DTE/Documento">
		<fo:block>
					...
					<fo:table-body>
						...
						<fo:table-row>
							<fo:table-cell text-align="left" font-weight="bold">
								<fo:block>Fecha: <xsl:value-of
										select="concat(' ', substring(TmstFirma,9,2),'/',substring(TmstFirma,6,2),'/',substring(TmstFirma,1,4))" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell text-align="right" font-weight="bold">
								<fo:block>&#160;Hora: <xsl:value-of
										select="concat(' ', substring(TmstFirma,12,5))" />
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
			...
			<!--
			+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
			<fo:table font-family="monospace" color="black" text-align="left"
				...
				<fo:table-header font-size="8pt" border-top-width="0.8pt" border-top-style="solid"
					border-bottom-width="0.8pt" border-bottom-style="solid" height="0.3cm">
				...
				<fo:table-body font-size="8pt">
					...
					<fo:table-row>
						<fo:table-cell number-columns-spanned="4" border-top-width="0.9pt"
							border-top-style="solid" height="0.3cm">
							<fo:block />
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell text-align="right" column-number="3" height="0.5cm">
							<fo:block>
								<fo:inline font-weight="bold">IVA <xsl:value-of
										select="Encabezado/Totales/TasaIVA" />
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="right" column-number="4" height="0.5cm">
	...
	<xsl:template match="Detalle">
		<fo:table-row>
			<fo:table-cell font-weight="bold" text-align="center" height="0.5cm">
				<fo:block>
					<xsl:value-of select="QtyItem" />
					<xsl:value-of select="UnmdItem" />
				</fo:block>
			</fo:table-cell>
			<fo:table-cell font-weight="bold" text-align="left" height="0.5cm">
				<fo:block>
					<xsl:value-of select="NmbItem" />
				</fo:block>
			</fo:table-cell>
			<fo:table-cell font-weight="bold" text-align="right" height="0.5cm">
				<fo:block>
	...
	<xsl:template match="Emisor">
		...
		<!-- Recuadro folio 
		+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		<fo:block-container width="6.5cm"
			border-color="black" border-style="solid" border-width="0.8mm" padding="1mm">
			<fo:block font-size="10pt" font-weight="bold" font-family="Courier" color="black" text-align="center"
			...
			<fo:block font-size="11pt" font-weight="bold" font-family="Courier" color="black" text-align="center">
		N&#xB0;<xsl:value-of select="$folio" /></fo:block>
		</fo:block-container>
		<fo:block-container>
			<fo:block padding-top="0.3mm" font-size="9pt" font-family="Helvetica" font-weight="bold" color="black" text-align="center" hyphenate="false"> SII - <xsl:value-of select="CmnaOrigen" />
			</fo:block>
		</fo:block-container>
		<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		<!-- Emisor 
		...
		<fo:block-container>
			<fo:block font-weight="bold" font-size="12pt" font-family="sans-serif" language="es" hyphenate="true" 
			color="black" text-align="left"><xsl:value-of select="RznSoc" />
			</fo:block>
			<xsl:if test="Sucursal">
				<fo:block font-weight="regular" font-size="9pt" font-family="sans-serif"
					language="es" hyphenate="true"
					color="black" text-align="left"> Sucursal: <xsl:value-of select="Sucursal" />
		(Codigo SII: <xsl:value-of select="CdgSIISucur" /> ) </fo:block>
			</xsl:if>

			<fo:block font-weight="regular" font-size="9pt" font-family="sans-serif" language="es"
				hyphenate="true"
			...
			<fo:block font-weight="regular" font-size="9pt" font-family="sans-serif" language="es"
				hyphenate="true"
				color="black" text-align="left">
				<xsl:value-of select="DirOrigen" />, <xsl:value-of select="CmnaOrigen" />, <xsl:value-of select="CiudadOrigen" />
			</fo:block>
	...
	<xsl:template match="Receptor">
		...
		<fo:block-container>
			...
			<fo:block font-weight="normal" font-size="7pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">RUT: <xsl:call-template
					name="RutFormat">
					<xsl:with-param name="rut">
			...
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Giro: <xsl:value-of
					select="GiroRecep" /></fo:block>
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Direccion: <xsl:value-of
					select="DirRecep" />
			</fo:block>
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Comuna: <xsl:value-of select="CmnaRecep" />
			</fo:block>
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Ciudad: <xsl:value-of select="CiudadRecep" />
			</fo:block>
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Teléfono: <xsl:value-of select="Contacto" />
			</fo:block>
			<fo:block font-weight="normal" font-size="8pt" font-family="sans-serif" language="es"
				hyphenate="true" color="black" text-align="left">Correo: <xsl:value-of select="CorreoRecep" />
			</fo:block>
		</fo:block-container>
	</xsl:template>
	...
	<xsl:template name="FechaFormat">
		...
		de <xsl:value-of select="substring($fecha,string-length($fecha)-9,4)" />
	</xsl:template>
