/**
 * QueryEstUpServiceCallbackHandler.java
 *
...
/**
 * QueryEstUpServiceCallbackHandler Callback class, Users can extend this class and implement their
 * own receiveResult and receiveError methods.
 */
public abstract class QueryEstUpServiceCallbackHandler {
   ...
   */
  public QueryEstUpServiceCallbackHandler(Object clientData) {
    this.clientData = clientData;
  }

  /** Please use this constructor if you don't want to set any clientData */
  public QueryEstUpServiceCallbackHandler() {
  ...
  public void receiveResultgetVersionMayor(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetVersionMayorResponse result) {}
  ...
  public void receiveResultgetVersionMenor(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetVersionMenorResponse result) {}
  ...
  public void receiveResultgetState(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetStateResponse result) {}
  ...
  public void receiveResultgetVersion(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetVersionResponse result) {}
  ...
  public void receiveResultgetVersionPatch(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetVersionPatchResponse result) {}
  ...
  /**
   * auto generated Axis2 call back method for getEstUp method override this method for handling
   * normal response from getEstUp operation
   */
  public void receiveResultgetEstUp(
      cl.fapp.siiclient.axis.query.estup.QueryEstUpServiceStub.GetEstUpResponse result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * getEstUp operation
   */
  public void receiveErrorgetEstUp(java.lang.Exception e) {}
}
