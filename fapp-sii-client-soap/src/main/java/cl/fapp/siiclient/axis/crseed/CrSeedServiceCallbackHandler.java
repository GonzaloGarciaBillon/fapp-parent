/**
 * CrSeedServiceCallbackHandler.java
 *
...
/**
 * CrSeedServiceCallbackHandler Callback class, Users can extend this class and implement their own
 * receiveResult and receiveError methods.
 */
public abstract class CrSeedServiceCallbackHandler {
   ...
   */
  public CrSeedServiceCallbackHandler(Object clientData) {
    this.clientData = clientData;
  }

  /** Please use this constructor if you don't want to set any clientData */
  public CrSeedServiceCallbackHandler() {
  ...
  public void receiveResultgetVersionMayor(
      cl.fapp.siiclient.axis.crseed.CrSeedServiceStub.GetVersionMayorResponse result) {}
  ...
  public void receiveResultgetVersionMenor(
      cl.fapp.siiclient.axis.crseed.CrSeedServiceStub.GetVersionMenorResponse result) {}
  ...
  /**
   * auto generated Axis2 call back method for getSeed method override this method for handling
   * normal response from getSeed operation
   */
  public void receiveResultgetSeed(
      cl.fapp.siiclient.axis.crseed.CrSeedServiceStub.GetSeedResponse result) {}
  ...
  public void receiveResultgetState(
      cl.fapp.siiclient.axis.crseed.CrSeedServiceStub.GetStateResponse result) {}
  ...
  public void receiveResultgetVersionPatch(
      cl.fapp.siiclient.axis.crseed.CrSeedServiceStub.GetVersionPatchResponse result) {}
