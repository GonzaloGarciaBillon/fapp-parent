...
@NoArgsConstructor
@ToString
@Schema(description = "Entrada para el servicio de generacion de nota de credito")
/**
 * Entrada para el servicio de generacion de nota de credito
 */
public class GenerarNotaCreditoRequest extends DTEDocumento {
