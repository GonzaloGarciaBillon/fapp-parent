...
@NoArgsConstructor
@ToString
@Schema(description = "Entrada para el servicio de generacion de nota de debito")
/**
 * Entrada para el servicio de generacion de nota de debito
 */
public class GenerarNotaDebitoRequest extends DTEDocumento {
